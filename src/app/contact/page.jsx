...
const ContactUs = () => {
  ...
  const mapEmbedUrl = "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3444.906380563344!2d78.05229827481848!3d30.29672670657495!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390929479e407e3b%3A0x75634bce639f3592!2sUttarakhand%20Blood%20Centre%20%E2%80%93%20Blood%20Bank%20in%20Dehradun!5e0!3m2!1sen!2sin!4v1772349864745!5m2!1sen!2sin";
    ...
    <div className="min-h-screen bg-[#fcfcfd] flex flex-col items-center justify-center p-4 md:p-8 mt-28 md:mt-8">
      ...
      <div className="max-w-7xl w-full bg-white rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col lg:flex-row border border-slate-100">
        ...
        <div className="lg:w-1/2 min-h-[500px] bg-slate-100 relative group/map">
          ...
          <a
            href="https://www.google.com/maps/search/?api=1&query=Uttarakhand+Blood+Centre+Haridwar+Road+Dehradun"
            target="_blank"
